...
SELECT [CompanyID], [Name], [YearID], [Нематериальные активы], [Основные средства], [Незавершенное строительство]
...
max(column_value)
FOR column_name IN
([CompanyID], [Name], [YearID], [Нематериальные активы], [Основные средства], [Незавершенное строительство])
